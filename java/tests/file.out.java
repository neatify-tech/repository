public class File {
	...
	public static void main(String[] args) {
		...
		else if ("this string is a bit long" == "this string is not too long"
				&& "but this string is more" == "than this string?") {
			System.out.println("yes!");
		}
		else {
			call(a, b);
		}
		while (s.equals("this string is a bit long")
				&& t.equals("this string is not too long")
				&& u.equals("but this string is more")
				&& v.equals("than this string?")) {
			call(a, b);
		}
		switch (a) {
			case 0:
		...
		try (java.io.ByteArrayInputStream in1 = new java.io.ByteArrayInputStream(new byte[0]);
				...
				java.io.ByteArrayInputStream in3 = new java.io.ByteArrayInputStream(new byte[0])) {
			call(a, b);
		}
